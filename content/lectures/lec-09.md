...
To do the demo you need your own Git repository so you can test out workflows. Fork [this](https://github.com/cis1912/ci-demo) repository and clone the forked repository onto your machine. Once you have cloned the forked repository, reset the repository to an earlier commit as follows so that we can do the steps demoed in lecture:
```
$ cd ci-demo
